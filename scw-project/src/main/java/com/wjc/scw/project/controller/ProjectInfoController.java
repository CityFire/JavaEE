...
import com.wjc.scw.project.vo.resp.ProjectDetailVo;
import com.wjc.scw.project.vo.resp.ProjectVo;
import com.wjc.scw.project.vo.resp.ReturnPayConfirmVo;
...
public class ProjectInfoController {
	...
	public AppResponse<ReturnPayConfirmVo> returnInfo(
		...
		AppResponse<TMember> resp = memberServiceFeign.getMebmerById(memberid); // 调用远程获取会员数据。
